...
export function Hero() {
  ...
  const render = () => {
    ...
    const title1Size =
      lang === 'en'
        ? 'text-[22.5px] ml:text-[31px]  lg:text-[83px] md:text-[65px]'
        : 'text-[20px]   ml:text-[28px]  lg:text-[77px] md:text-[60px]'

    const title2Size =
      lang === 'en'
        ? 'text-[30px]   ml:text-[41px]  lg:text-[109px] md:text-[85px]'
        : 'text-[25px]   ml:text-[34px]  lg:text-[94px] md:text-[74px]'

    const brandSize  = 'text-[65px] ml:text-[90px] lg:text-[240px] md:text-[195px]'
