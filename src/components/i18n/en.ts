...
export const en = {
  ...
  blog_cta_sub: 'Tell us about it in a 30-minute call. The first meeting is free.',
  ...
  projects_status_developing: 'IN DEVELOPMENT',
  ...
  dgp_kicker: 'Library · Document processing',
  dgp_tagline: 'Document processing as a library.',
  dgp_desc:
    'ProDoctivity DGP (Document Processing Generator) is a library NexaDigit is building for ProDoctivity: it plugs into any system that needs to process documents —classify them, extract their data, create templates and generate documents from them— without depending on a separate platform.',
  dgp_quote: "It isn't another tool to send documents to: it lives inside the system the client already uses.",
  dgp_tag_1: 'Data extraction',
  dgp_tag_2: 'Classification',
  dgp_tag_3: 'Templates',
  dgp_tag_4: 'Embeds in any system',
  dgp_mock_caption: 'DOCUMENT PROCESSING GENERATOR',
  dgp_caption: 'Library in development for ProDoctivity: input documents, extracted data and output templates.',

  /* ── Process ────────────────────────────────────────────────────────── */
  process_eyebrow: 'Process',
  process_title: 'How we work.',
  process_lede:
    'We work in four steps: a first meeting to gather your requirements, a free demo MVP, a quote with the cost of the first version plus annual support, and development in delivery phases —Phase 0, Phase 1, Phase 2…— with a detailed report at each one until version 1 is delivered.',
  process_deliverable_label: 'DELIVERABLE:',
  process_table_caption: 'Steps, deliverables, and cost',
  process_table_phase: 'Step',
  process_table_deliverable: 'Deliverable',
  process_table_cost: 'Cost',
  process_1_title: 'First meeting',
  process_1_desc:
    'A first meeting, at no cost, to gather your company’s requirements and understand the system you want: what problem it solves, who will use it, and with what information.',
  process_1_deliverable: 'Requirements and initial scope · no cost',
  process_2_title: 'Free MVP',
  process_2_desc:
    'We build a free demo MVP so you can see how the system would work before deciding anything. You evaluate something real, not a slide deck.',
  process_2_deliverable: 'Working demo MVP · free',
  process_3_title: 'Quote',
  process_3_desc:
    'Once the MVP is validated we send the quote: the initial cost of the first version and an annual support cost covering later requirements, technical assistance, and maintenance.',
  process_3_deliverable: 'Written quote: first version + annual support · initial cost and annual cost',
  process_4_title: 'Delivery phases',
  process_4_desc:
    'Once the proposal is accepted, work proceeds in phases —Phase 0, Phase 1, Phase 2…—. At the close of each you receive a detailed progress report, until version 1 is completed and delivered.',
  process_4_deliverable: 'Detailed report per phase through version 1 · included in the quote',

  /* ── FAQ ────────────────────────────────────────────────────────────── */
  faq_eyebrow: 'Questions',
  faq_title: 'What everyone asks.',
  faq_1_q: 'How much does a project cost?',
  faq_1_a: 'It depends on scope. The first meeting and the demo MVP are free; then you receive a written quote with the initial cost of the first version and an annual support cost.',
  faq_2_q: 'How is the development organized?',
  faq_2_a: 'In delivery phases —Phase 0, Phase 1, Phase 2…—, each closed with a detailed progress report, until version 1 is delivered. Before that, the free MVP shows you what the system will be like.',
  faq_3_q: 'What happens after delivery?',
  faq_3_a: "Annual support: later requirements, technical assistance, and maintenance. We don't deliver and disappear — we operate our own systems and know what production demands.",
  ...
  contact_next_2: 'A first meeting, at no cost, to gather your requirements and understand the system you want.',
  contact_next_3: 'A free MVP so you see the system working before receiving the quote.',
  form_first: 'First name',
  form_last: 'Last name',
  form_email: 'Email address',
  form_phone: 'Phone',
  form_company: 'Company',
  form_service_legend: 'What are you interested in?',
  form_service_1: 'Autonomous agents in production',
  form_service_2: 'AI workflow automation',
  form_service_3: 'AEO content (get cited by chatbots)',
  form_service_4: 'Consulting and architecture',
  form_service_5: "Other / not sure",
  form_message: 'Your project (optional)',
  form_message_placeholder: 'What problem you want to solve and who will use it',
  form_submit: 'Request the first meeting',
  form_privacy_pre: 'No commitment. By sending you accept our',
