...
export const es = {
  ...
  faq_7_q: '¿Qué es un MVP?',
  faq_7_a: 'Un MVP (producto mínimo viable) es la versión más pequeña de un sistema que ya resuelve el problema principal de principio a fin: tiene solo las funciones imprescindibles para usarlo y evaluarlo con datos reales, sin los módulos, integraciones ni acabados de la versión completa. En NexaDigit el MVP es gratuito y se construye después del primer encuentro, para que usted vea el sistema funcionando —no una presentación— antes de recibir la cotización. Lo que valida en ese MVP es la base sobre la que se construye la versión 1 por fases.',
  ...
  contact_next_2: 'Primer encuentro, sin costo, para levantar sus necesidades y entender el sistema que desea.',
  contact_next_3: 'MVP gratuito para ver el sistema funcionando antes de recibir la cotización.',
  form_first: 'Nombre',
  form_last: 'Apellido',
  form_email: 'Correo electrónico',
  form_phone: 'Teléfono',
  form_company: 'Empresa',
  form_service_legend: '¿Qué le interesa?',
  form_service_1: 'Agentes autónomos en producción',
  form_service_2: 'Automatización de flujos con IA',
  form_service_3: 'Contenido AEO (que los chatbots me citen)',
  form_service_4: 'Consultoría y arquitectura',
  form_service_5: 'Otro / no estoy seguro',
  form_message: 'Su proyecto (opcional)',
  form_message_placeholder: 'Qué problema quiere resolver y quién lo usará',
  form_submit: 'Solicitar el primer encuentro',
  form_privacy_pre: 'Sin compromiso. Al enviar acepta la',
