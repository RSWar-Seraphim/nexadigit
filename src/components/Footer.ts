...
<footer role="contentinfo" aria-label="Site footer"
  ...
  <div class="relative max-w-[500px] mx-auto flex items-center justify-between">
    ...
    <span class="flex gap-1.5">
      <a href="/privacy"  class="hover:underline" data-legal="privacy">${t('footer_privacy')}</a>
      <a href="/terms"    class="hover:underline" data-legal="terms">${t('footer_terms')}</a>
      <a href="/cookies"  class="hover:underline" data-legal="cookie">${t('footer_cookie')}</a>
    </span>
  </div>
</footer>`;
}
...
<footer role="contentinfo" aria-label="Site footer"
  ...
  <div class="max-w-[960px] mx-auto grid grid-cols-3 items-center">
    ...
    <span class="justify-self-end flex gap-6">
      <a href="/privacy"  data-legal="privacy" class="hover:underline">${t('footer_privacy')}</a>
      <a href="/terms"    data-legal="terms"   class="hover:underline">${t('footer_terms')}</a>
      <a href="/cookies"  data-legal="cookie"  class="hover:underline">${t('footer_cookie')}</a>
    </span>
  </div>
</footer>`;
}
